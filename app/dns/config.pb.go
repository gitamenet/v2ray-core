...
import (
	...
	math "math"
	router "github.com/gitamenet/v2ray-core/app/router"
...
func init() {
	proto.RegisterFile("github.com/gitamenet/v2ray-core/app/dns/config.proto", fileDescriptor_ed5695198e3def8f)
}
