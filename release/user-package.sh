...
get_source() {
	...
	go get -insecure -v -t github.com/gitamenet/v2ray-core/...
	SRCDIR="$GOPATH/src/github.com/gitamenet/v2ray-core"
}

build_v2() {
	pushd $SRCDIR
	LDFLAGS="-s -w -X github.com/gitamenet/v2ray-core.codename=${CODENAME} -X github.com/gitamenet/v2ray-core.build=${BUILDNAME}  -X github.com/gitamenet/v2ray-core.version=${VERSIONTAG}"
